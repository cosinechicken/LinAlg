...
//            System.out.println("Row #" + i + " has been entered. ");
        ...
        while (!quitNow) {
            ...
            if (inputArr[0].equals("H")) {
                ...
                System.out.println("\"O\": Find an orthogonal basis of the rows of the matrix. The matrix itself is not affected. ");
                ...
                System.out.println("The following rows are an orthogonal basis for the rows of the matrix: ");
